  ...
  return (
    <container>
      ...
      <div className="col-md-10" style={{ float: "right", marginTop: "20px" }}>
        ...
        <a href={props.link} target={"_blank"} ><button className="btn btn-success" style={{ marginBottom: "30px" }}>
          View
              </button></a>
        <button onClick={props.handleSaveBook} className="btn btn-success" style={{ marginBottom: "30px", marginLeft: "20px" }}>
          Save
              </button>
